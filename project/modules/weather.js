...
function displayCurrent(data, targetEl) {
...
function displayForecast(days, forecastBox) {
...
export async function displayWeather(currentWeatherBox, forecastBox) {
  try {
    ...
    displayCurrent(current, currentWeatherBox);
    displayForecast(forecast, forecastBox);
  } catch (error) {
